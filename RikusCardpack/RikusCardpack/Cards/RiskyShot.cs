...
namespace RikusCardpack.Cards
{
    class RiskyShot : CustomCard
    {
        ...
        {
            return "Block while reloading to do a risky shot, giving you 2s to hit a shot that instakills and removes 15% max hp, otherwise you are set to 1 hp for at least 10s.";
        }
